...
function FamilyTreeApp() {
  ...
  useEffect(() => {
    async function fetchData() {
      const { data } = await axios.get('http://localhost:3005/families-with-members', {
        headers: {
  ...
  return (
    <>
      <div className="my-5">
        <h3 className="text-dark">Family Name: {formattedFamiliesData[index]?.family_name}</h3>
        <p className="text-dark">Head of Family: {formattedFamiliesData[index]?.family_head_name}</p>
            ...
            <Carousel.Item key={familyIndex} className="treecontainer">
              {familyData?.members?.map((member, index2) => (
                <React.Fragment key={member.member_id}>
                  {member.member_as === "Patriarch_Father" && member.sub_family_of === null && (
                    <img
                      className='parent1'
                      src={member.member_image || 'https://randomuser.me/api/portraits/women/64.jpg'}
                      alt=""
                  ...
                  {member.member_as === "Patriarch_Mother" && member.sub_family_of === null && (
                    <img
                      className='parent2'
                      src={member.member_image || 'https://randomuser.me/api/portraits/women/64.jpg'}
                      alt=""
                  ...
                  {member.member_as === "Matriarch_Father" && member.sub_family_of === null && (
                    <img
                      className='parent21'
                      src={member.member_image || 'https://randomuser.me/api/portraits/women/64.jpg'}
                      alt=""
                  ...
                  {member.member_as === "Matriarch_Mother" && member.sub_family_of === null && (
                    <img
                      className='parent22'
                      src={member.member_image || 'https://randomuser.me/api/portraits/women/64.jpg'}
                      alt=""
